...
# time.
TOKEN_PATH = "groups_token.yaml".freeze
...
# List the first 10 groups in the domain
response = service.list_groups(customer:    "my_customer",
                              max_results: 500)
puts "Groups:"
puts "No groups found" if response.groups.empty?
response.groups.each { |group| puts group.inspect }
